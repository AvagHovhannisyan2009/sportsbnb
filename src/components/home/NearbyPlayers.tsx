...
const allFakePlayers = [
  ...
  { name: "Tigran H.", sport: "Football", distance: 0.3, initials: "TH", level: "Advanced" },
  { name: "Gagik P.", sport: "Football", distance: 0.4, initials: "GP", level: "Beginner" },
  { name: "Narek B.", sport: "Football", distance: 0.5, initials: "NB", level: "Intermediate" },
  { name: "Suren A.", sport: "Football", distance: 0.6, initials: "SA", level: "Advanced" },
  { name: "Hovhannes L.", sport: "Football", distance: 0.7, initials: "HL", level: "Intermediate" },
  { name: "Vardan D.", sport: "Football", distance: 0.8, initials: "VD", level: "Beginner" },
  { name: "Karen M.", sport: "Football", distance: 0.9, initials: "KM", level: "Advanced" },
  { name: "Aram T.", sport: "Football", distance: 1.0, initials: "AT", level: "Intermediate" },
  { name: "Gevorg S.", sport: "Football", distance: 1.1, initials: "GS", level: "Beginner" },
  { name: "Levon R.", sport: "Football", distance: 1.2, initials: "LR", level: "Advanced" },
  { name: "Ashot V.", sport: "Football", distance: 1.3, initials: "AV", level: "Intermediate" },
  { name: "Ruben G.", sport: "Football", distance: 1.4, initials: "RG", level: "Beginner" },
  // Tennis players
